...
//			Statement stmt = createInsertStmt(origin, sb, !controller.getAllStructNames().contains(type));
	 ...
	 abstract List<AtomicRunModel> generateModel(AtomicRunModel model, List<String> types, HashMap<String, Statement> typeInsertMap);
