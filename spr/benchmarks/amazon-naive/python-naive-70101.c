...
PyZlib_objdecompress(compobject *self, PyObject *args)
{
    ...
    */
    ...
    if ((max_length) || 1) {
        do {
            if (--((PyObject *)(self->unconsumed_tail))->ob_refcnt != 0)
                ;
            else
                ((*(((PyObject *)((PyObject *)(self->unconsumed_tail)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(self->unconsumed_tail))));
        } while (0);
        self->unconsumed_tail = PyBytes_FromStringAndSize((char *)self->zst.next_in, self->zst.avail_in);
        if (!self->unconsumed_tail) {
            do {
                if (--((PyObject *)(RetVal))->ob_refcnt != 0)
                    ;
                else
                    ((*(((PyObject *)((PyObject *)(RetVal)))->ob_type)->tp_dealloc)((PyObject *)((PyObject *)(RetVal))));
            } while (0);
            RetVal = ((void *)0);
            goto error;
        }
