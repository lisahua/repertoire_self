...
reassembled_table_init(GHashTable **reassembled_table)
{
	...
	if ((*reassembled_table != ((void *)0)) && !1) {
	    g_hash_table_foreach_remove(*reassembled_table, free_all_reassembled_fragments, ((void *)0));
	} else {
	    *reassembled_table = g_hash_table_new_full(reassembled_hash, reassembled_equal, reassembled_key_free, ((void *)0));
	}
}
